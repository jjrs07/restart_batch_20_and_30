...
| 06 | **MySQL Conditional Search and Data Organization** | Query a 20-employee dataset with conditional operators and built-in functions, then organize results with `ORDER BY`, `GROUP BY`, and `HAVING`. | [`06-mysql-conditional-search/`](06-mysql-conditional-search/) |
